...
//variabales for reversal task
int trialsToSwitch = 25;
int counter = 1;
...
void loop() {
  ...
  ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  //                                                                     Mode 4: Reversal Task Left
  ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  if (fed3.FEDmode == 4) {
    fed3.sessiontype = "RevT_L";                      //The text in "sessiontype" will appear on the screen and in the logfile
  ...
  ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  //                                                                     Mode 5: Reversal Task Right
  ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  if (fed3.FEDmode == 5) {
    fed3.sessiontype = "RevT_R";                        //The text in "sessiontype" will appear on the screen and in the logfile
    ...
    ////////////////////////////////////////////////
    if (counter == ((trialsToSwitch * 2)+1)) counter = 1;
    if (counter <= trialsToSwitch) fed3.activePoke = 0; //Right first
    if (counter > trialsToSwitch) fed3.activePoke = 1;  //Left  second
